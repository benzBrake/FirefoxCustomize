...
|      | 68   | [addMenuPlus](addMenuPlus.uc.js)                             | 自定义火狐菜单，也支持工具按钮移动                           | [📃](https://github.com/ywzhaiqi/userChromeJS/tree/master/addmenuPlus) |
|      | 70   | [AddonsPage](AddonsPage_fx72.uc.js)                          | 附件页面显示 userChromeJS 脚本列表<br />xiaoxiaoflod 的 userChromeJS 环境仅可展示，不可管理<br />仅在 Firefox 100 中测试过 | [📃](https://u6.getuploader.com/script/download/2051)         |
