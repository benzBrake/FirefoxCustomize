...
// @note           修改为非 MrOtherGuy 的 UC 环境可用，汉化并调整快捷键为 Ctrl+F1
// ==/UserScript==
...
(function () {
    let config = {
        ...
        l10n: {
            "Button label": `垂直标签栏`, // label and tooltip for the toolbar button
            "Button tooltip": `显示/隐藏垂直标签栏`,
            "Collapse button tooltip": `缩小标签栏`,
        ...
        hotkey: {
            ...
            modifiers: "accel", // valid modifiers are "alt", "shift", "ctrl", "meta" and "accel". accel is equal to ctrl on windows and linux, but meta (cmd ⌘) on macOS. meta is the windows key on windows. it's variable on linux.
            key: "F1", // the actual key. valid keys are letters, the hyphen key - and F1-F12. digits and F13-F24 are not supported by firefox.
        },
    };
...
#vertical-tabs-tooltip #places-tooltip-insecure-icon[type="error-page"] {
    ...
    function _createElement(doc, tag, props, isHTML = false) {
    ...
    function _registerHotkey(desc, func) {
        ...
        try {
            ...
            _windows().forEach((doc, win) => {
                ...
                let el = _createElement(doc, "key", details);
