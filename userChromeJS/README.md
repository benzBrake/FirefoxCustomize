...
|      | 100  | [CopyCatTheme](CopyCatTheme.uc.js)                           | 读取 Firefox CSS 主题                                        |                                                              |
...
| 🅰️    | 103  | [privateTab](privateTab.uc.js)                               | 添加无痕标签功能，支持自定义无痕身份的名字，因为我换到了 alice0775 的 UC 环境，所以最新版直接针对该环境进行修改了 | [📃](https://github.com/xiaoxiaoflood/firefox-scripts/blob/master/chrome/privateTab.uc.js) |
