...
// @icon        https://img.gejiba.com/images/c77d4ec92956cfb9abb1aff126772daf.png
// @run-at document-end
...
!function(){
    ...
    var imgUrl      = GM_getValue("check_mUrl",    "https://img.gejiba.com/images/c77d4ec92956cfb9abb1aff126772daf.png"); // 图标地址
    var configForm; // 设置界面
    ...
    function addBtn(nodeName){
        ...
        insNode.style = "border:0px !important;width:"+imgWidth+"px !important;height:"+imgHeight+"px !important;background-image: url('"+imgUrl+"'); background-repeat: no-repeat; background-size: 100% 100%;position: fixed;z-index: 99 !important;overflow: hidden;transition-duration: 0.2s !important;transition-delay: 0.3s !important;"+deltaTextY+deltaTextX;
        ...
        node.expand = function(){
            ...
            node.style = "position:fixed;bottom:-11px !important;z-index:99 !important;bottom:-5px !important;height:auto !important;width:"+percentage+"% !important;overflow:hidden;transition-delay:0.1s !important; background:#fcfcfc;"+posTextX;
